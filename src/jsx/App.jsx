    ...
    <div className="app" ref={appRef}>
      <div className="app_container">
        ...
        <div className="content">
          ...
          <div ref={isVisibleRef1} className={`number_container left total_cost ${(isVisible1) ? 'visible' : ''}`}>
          ...
          <div className={`number_container right share_gdp ${(isVisible1) ? 'visible' : ''}`}>
            <h3 className="share_gdp">Financial burden</h3>
            <div className="dots_container">
              <div className="dots">
                {
                        Array(parseInt(10, 10)).fill().map((el, i) => <div key={uuidv4()} className="dot"><span className={`dot_wrapper ${(i < (percentage_min + 1)) ? 'share' : ''}`}><span className={(isVisible1) ? 'visible' : ''} style={{ width: (i === percentage_min) ? `${percentage_rest}%` : '100%' }} /></span></div>)
                      }
                {
                        isVisible1 && visualiseDots()
                      }
              </div>
          ...
          <div className={`number_container left gap ${(isVisible1) ? 'visible' : ''}`}>
          ...
          <div className={`show_more_container ${(isVisible1) ? 'visible' : ''}`}>
